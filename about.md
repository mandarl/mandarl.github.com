...
<div class="about-header">
  ...
  <div class="about-intro">
    ...
    <div class="about-social">
      ...
      <a href="https://twitter.com/{{ site.twitter_username }}" class="btn btn-secondary" target="_blank" rel="noopener">Twitter</a>
      {% endif %}
      {% if site.github_username %}
      <a href="https://github.com/{{ site.github_username }}" class="btn btn-secondary" target="_blank" rel="noopener">GitHub</a>
      {% endif %}
      {% if site.linkedin_username %}
      <a href="https://linkedin.com/in/{{ site.linkedin_username }}" class="btn btn-secondary" target="_blank" rel="noopener">LinkedIn</a>
      {% endif %}
    </div>
  </div>
</div>
